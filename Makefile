...
pointer-selftest: ## Prove the injected-pointer path: a game click, mid1, a per-ROM layout, a toggle slot and the menu (usage: make pointer-selftest rom=/path/to/game.z64)
