...
CriticalSection::CriticalSection()
{
    ...
    // PTHREAD_MUTEX_RECURSIVE_NP is the glibc-only spelling; macOS does not
    // define it. PTHREAD_MUTEX_RECURSIVE is the portable POSIX name and is
    // also what Android's bionic libc defines PTHREAD_MUTEX_RECURSIVE_NP as
    // an alias for, so using it here is behavior-preserving on Android too.
