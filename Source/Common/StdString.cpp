...
#include <algorithm>
#ifdef __APPLE__
// macOS has no <malloc.h>. alloca() (the only thing this file needs from it)
// is declared via <stdlib.h> (which pulls in <alloca.h>), and <malloc/malloc.h>
// covers the rest of what <malloc.h> would otherwise provide.
#include <stdlib.h>
