...
extern "C" {
// On Apple these entry points come straight from OpenGL.framework via <OpenGL/glext.h>,
// as real functions rather than pointers. The pointer definitions and the loader that
// fills them live in OGLglitchmain.cpp under #ifdef _WIN32, so declaring them here would
// leave them null on Apple and clash with the framework prototypes.
#ifndef __APPLE__
