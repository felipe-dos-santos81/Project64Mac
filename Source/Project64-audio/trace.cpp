...
{
    // Runs after the settings have applied their own levels, and before the log_dir
    // check below, so PJ64_TRACE works whether or not a log directory is configured.
    TraceEnvSetup(MaxTraceModulePluginAudio, "audio");
