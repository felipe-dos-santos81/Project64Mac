// This decoder is architecture-neutral RSP instruction decoding. It carries the
// -x64 name for historical reasons and serves every target except 32-bit x86,
// which has its own variant in RSPInstruction-x86.h.
